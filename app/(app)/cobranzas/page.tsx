...
function agingClass(days: number | null): string {
  ...
  if (days > 60) return "font-bold text-[#B8402E] dark:text-[#EE9585]";
  if (days > 30) return "font-semibold text-[#A5721E] dark:text-[#E0B45E]";
        ...
        <section className="overflow-hidden rounded-[12px] border bg-card">
          ...
          {rows.map((row) => (
            ...
            >
              ...
              <span
                className={`text-right tabular-nums ${agingClass(row.oldestDays)}`}
              >
